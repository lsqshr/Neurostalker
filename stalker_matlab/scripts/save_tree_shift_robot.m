...
for i=1:num_shift_robot
    ...
    ori_saved_box=savebox(three_dim, box_size_define, shift_robot(i).x_loc,shift_robot(i).y_loc,shift_robot(i).z_loc,zero_size);
    shift_robot(i).ori_vision_box=ori_saved_box;
    ori_saved_box=savebox(salt_pepper_three_dim, box_size_define, shift_robot(i).x_loc,shift_robot(i).y_loc,shift_robot(i).z_loc,zero_size);
    shift_robot(i).sp_vision_box=ori_saved_box;
    ori_saved_box=savebox(ag_three_dim, box_size_define, shift_robot(i).x_loc,shift_robot(i).y_loc,shift_robot(i).z_loc,zero_size);
