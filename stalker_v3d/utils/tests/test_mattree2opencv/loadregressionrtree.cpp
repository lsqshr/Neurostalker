...
int main(int argc, char** argv )
{
    ...
    Ptr<RTrees> tree = Algorithm::load<RTrees>("../../data/model_alpha_filtered.xml");
    //Ptr<RTrees> tree = Algorithm::load<RTrees>("../../data/cvtrainedrtree.xml");
    ...
    cout<< "responses: " << responses.t() <<endl;
